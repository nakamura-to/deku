(function (pot, compiler) {
  var core = {
    ...
    compile: typeof compiler !== 'undefined' ? compiler.compile : function () {
      throw new Error("The pot.runtime.js doesn't support tp compile the partial template.");
    },
  ...
  if (typeof module !== 'undefined') {
    ...
    pot.internal.core = core;
  }

}(typeof module !== 'undefined' ? {} : pot,
  typeof module !== 'undefined' ? require('./compiler') : pot.internal.compiler));