(function (tempura, parser) {
    ...
    Compiler.prototype = {
      ...
      type_partial: function (node) {
        ...
        if (context) {
          ...
          this.type_name({path: '$this', segments: ['$this']});
        }
    ...
    JsCompiler.prototype = {
      ...
      generate: function (subPrograms, asString) {
        ...
        this.source[0] = this.source[0] + 'var tmp, buffer = "", contextStack = [context], index, hasNext, templateContext = this, ' +
          ...
          'prePipeline = this.prePipeline, postPipeline = this.postPipeline, processors = this.processors, processor, templates = this.templates, partial;' +
          '\n\n' + subPrograms.join('\n\n') + '\n';
  ...
  if (typeof module !== 'undefined') {
    ...
    tempura.internal.compiler = compiler;
  }

}(typeof module !== 'undefined' ? {} : tempura,
  typeof module !== 'undefined' ? require('./parser') : tempura.internal.parser
));